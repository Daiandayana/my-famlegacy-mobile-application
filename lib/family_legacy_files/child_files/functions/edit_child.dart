...
class _EditChildState extends State<EditChild> {
  ...
  void initState() {
    ...
    _fetchSelectedChildData(widget.selectedChildID);
    _fetchSelectedSpouseData(widget.selectedSpouseID);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('Edit Child Details')),
                  ...
                  children: [
                    ...
                    if (selectedChild != null) ...[
                      ...
                      if (selectedSpouse != null) ...[
                        const Text('Current details of the spouse:'),
                        SizedBox(height: _heightSize),
