...
class _EditParentState extends State<EditParent> {
  ...
  void initState() {
    ...
    _fetchSelectedParentData(widget.selectedParentID);
  }

  Future<void> _fetchSelectedParentData(String id) async {
    ...
    try {
      if (selectedParent != null) {
        if (hasSpouse && selectedSpouse != null) {
          await updateParentFromGrandparent(
              widget.famLegacyID,
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return const AlertBox(
              type: 'Update Child successful',
              object: 'Successfully update child',
            );
          },
        ).then((_) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Parent Name: ${widget.gFatherName}'),
                    SizedBox(height: _heightSize),
                    Text("Parent's Spouse Name: ${widget.gMotherName}"),
                    SizedBox(height: _heightSize),
                    DropdownButtonFormField<String>(
                      ...
                      onChanged: (value) {
                        ...
                        if (selectedParentID.isNotEmpty) {
                          _fetchSelectedParentData(selectedParentID);
                        }
                      },
                      validator: (value) {
