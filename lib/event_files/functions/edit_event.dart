...
class _EditEventState extends State<EditEvent> {
  ...
  void initState() {
    ...
    _eventNameCont.text = widget.eventName;
    _eventLocationCont.text = widget.eventLocation;
    _selectedDate = widget.eventDate.toDate();
    _selectedTime = TimeOfDay.fromDateTime(widget.eventDate.toDate());
  }
